...
def convert_label_to_similarity(normed_feature: Tensor, label: Tensor) -> Tuple[Tensor, Tensor]:
    ...
    negative_matrix = numpy.logical_not(label_matrix.cpu()).triu(diagonal=1)
...
class GBF(nn.Module):
    ...
    def forward(self,
                ...
                **kwargs):
        # self.GBF(output['hm'], batch['hm'],batch['wh'],batch['location_class'])
